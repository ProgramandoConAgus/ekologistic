            ...
            <div class="row align-items-center">
              ...
              <div class="col-md-12">
                <div class="page-header-title">
                  <h2 class="mb-0">Inventario N° 2231 - Packing List N° 99238</h2>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <table class="table table-hover tbl-product" id="pc-dt-simple">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <i class="ph-duotone ph-check-circle text-primary f-24" data-bs-toggle="tooltip" data-bs-title="danger"></i>
                        </td>
                        <td class="text-center">
                          <div >
                            <ul class="list-inline me-auto mb-0">
