...
<head>
  <title>Liquidaciones Imports | Eko Logistic</title>
  <!-- [Meta] -->
  <meta charset="utf-8" />
          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Imports</li>
              </ul>
            </div>
            <div class="col-md-12">
              <div class="page-header-title">
                <h2 class="mb-0">Panel Imports</h2>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card table-card">
            <div class="card-body pt-3">
              <div class="d-flex justify-content-end mb-3">
                <a class="text-white" href="../application/crearImport.php"><button type="button" class="btn btn-success text-white me-3">Cargar nuevo Imports</button></a>
              </div>
                        ...
                        <tr>
                          ...
                          <td>
                            <select
                              ...
                              <?php
                              $queryselect  = "SELECT IdEstados, nombre FROM estadosliquidacion where nombre <> 'Liquidacion Total'";
