...
<head>
  <title>Form Elements | Light Able Admin & Dashboard Template</title>
  <!-- [Meta] -->
  <meta charset="utf-8" />
          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Cargar BL</li>
              </ul>
            </div>
            <div class="col-md-12">
              <div class="page-header-title">
                <h2 class="mb-0">Nuevo BL</h2>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="alert alert-primary d-flex align-items-center" role="alert">
                    ...
                    <div> Los contenedores que aparezcan en disponibles serán únicamente los que fueron previamente cargados en el sistema. </div>
                </div>
            </div>
            <div class="mb-3 col-md-6">
                <label class="form-label" for="inputEmail4">N° Packing List</label>
                <input type="email" class="form-control" id="inputEmail4" placeholder="Número">
            </div>
            <div class="mb-3 col-md-6">
                <label class="form-label" for="inputPassword4">Destino</label>
                <input type="password" class="form-control" id="inputPassword4" placeholder="Destino">
            </div>
        </div>
        <div class="row">
            <div class="mb-3 col-md-12">
                <label class="form-label" for="inputState">Contenedores</label>
                <select id="inputState" class="form-select">
                    <option selected>Seleccionar</option>
                    <option>Contenedor N° 998231</option>
                </select>
            </div>
            <div class="mb-3 col-md-6">
                <label for="demo-date-only" class="form-label">Fecha Salida</label>
                <input class="form-control" type="date" value="2021-12-31" id="demo-date-only">
            </div>
            <div class="mb-3 col-md-6">
                <label for="demo-date-only" class="form-label">Fecha Estimada Llegada</label>
                <input class="form-control" type="date" value="2021-12-31" id="demo-date-only">
            </div>
        </div>
        <div class="mb-3">
            <label for="demo-input-file" class="form-label">Archivos asociados</label>
            <input class="form-control" type="file" id="demo-input-file">
        </div>
        
        <!-- Contenedor para alinear los botones: "Volver" a la izquierda y "Crear" a la derecha -->
        <div class="d-flex justify-content-between">
            <a href="../dashboard/index.php"><button type="button" class="btn btn-primary">Volver</button></a>
