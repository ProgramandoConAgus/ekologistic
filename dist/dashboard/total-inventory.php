...
$sql = "SELECT 
  ...
  i.Total_Price_INCOTERM AS 'TOTAL PRICE INCOTERM',
...
// Comex total
$total_comex = 0;
// Totales para campos marcados (tomate/verde)
$total_price_exw = 0; // tomate: Total Price EXW
$total_price_incoterm = 0; // verde: Total Price INCOTERM
...
while ($row = $result->fetch_assoc()) {
  ...
  if ($row['STATUS'] == 'Completed') {
    ...
    $total_comex += $row['TOTAL PRICE INCOTERM'] ?? 0;
    $total_price_exw += $row['TOTAL PRICE EXW'] ?? 0;
    $total_price_incoterm += $row['TOTAL PRICE INCOTERM'] ?? 0;
  } else {
    $status = "Transit";
              ...
              <div class="card-body">
                <div class="d-flex align-items-center">
                  ...
                  <div class="ms-auto text-end text-white">
                      ...
                      $<?= number_format($total_price_exw, 2) ?>
                    </h3>
            ...
            <div class="card prod-p-card bg-success mb-0">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  ...
                  <div class="ms-auto text-end text-white">
          <h3 class="mb-0 text-white">
            $<?= number_format($total_price_incoterm, 2) ?>
          </h3>
