          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Contenedores</li>
              </ul>
            </div>
            <div class="col-md-12">
              <div class="page-header-title">
                <h2 class="mb-0">Crear Contenedor</h2>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-12">
          <div class="card shadow-none border mb-0">
            <div class="card-body p-3">
              <div class="d-flex align-items-center">
                <div class="flex-shrink-0">
                  <i class="ph-duotone ph-package f-36 text-primary"></i>
                </div>
                <div class="flex-grow-1 ms-3">
                  <div class="d-flex align-items-center justify-content-center gap-2 text-success">
                    <i class="ti ti-circle f-10"></i>
                    <p class="mb-0">Agregado</p>
                  </div>
                </div>
                <div class="flex-shrink-0">
                  <h6 class="mb-0">Producto Genérico</h6>
                  <p class="mb-0">Cantidad: 300</p>
                  <p class="mb-0">Precio Unitario: $120.00</p>
                  <p class="mb-0">Total: $360.00</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-12">
          <div class="card shadow-none border mb-0">
            <div class="card-body p-3">
              <div class="d-flex align-items-center">
                <div class="flex-shrink-0">
                  <i class="ph-duotone ph-shopping-bag f-36 text-primary"></i>
                </div>
                <div class="flex-grow-1 ms-3">
                  <div class="d-flex align-items-center justify-content-center gap-2 text-success">
                    <i class="ti ti-circle f-10"></i>
                ...
                <div class="flex-shrink-0">
                  <h6 class="mb-0">Producto Genérico</h6>
                  <p class="mb-0">Cantidad: 100</p>
                  <p class="mb-0">Precio Unitario: $800.00</p>
                  <p class="mb-0">Total: $800.00</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <span class="card shadow-none border mb-0">
              <span class="card-body p-3 text-center">
               ...
               <span class="d-flex align-items-center justify-content-center gap-2 flex-column">
                  ...
                  <span class="text-muted">Agregar Productos</span>
                </span>
               </a>
              </span>
            </span>
