          ...
          <form id="formLogin">
            <div class="card-body">
              ...
              <div class="d-flex mt-1 justify-content-between align-items-center">
                <a href="./forgot-password/forgot-password.php" class="link-primary ms-1">
                  <h6 class="f-w-400 mb-0">Recuperar contraseña</h6>
                </a>
              </div>
              <div class="d-grid mt-4">
                <button type="submit" style="background-color:#afc97c" class="btn text-white">Ingresar</button>
              </div>
            </div>
          </form>
        </div>
